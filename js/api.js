...
export async function getSongs({ page = 1, pageSize = PAGINATION.DEFAULT_PAGE_SIZE, search = '', type = '' } = {}) {
  const cacheKey = `songs:page:${page}:size:${pageSize}:search:${search}:type:${type}`;
